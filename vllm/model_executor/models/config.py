...
class HybridAttentionMambaModelConfig(VerifyAndUpdateConfig):
    ...
    def verify_and_update_config(cls, vllm_config: "VllmConfig") -> None:
        ...
        if cache_config.enable_prefix_caching and model_config.model not in ['LiquidAI/LFM2-700M', 'LiquidAI/LFM2-1.2B', 'LiquidAI/LFM2-2.6B']:
        ...
        elif cache_config.enable_prefix_caching and model_config.model in ['LiquidAI/LFM2-700M', 'LiquidAI/LFM2-1.2B', 'LiquidAI/LFM2-2.6B']:
        # 이거거나 non-pc와 같다
        # 1. 맘바 따라하기
            # from math import gcd
